...
<head>
    ...
    <title>Login | Diskuperdagin</title>
    <link rel="shortcut icon" href="asset_user/img/Cianjur.png" type="image/x-icon">

    <!-- Font Icon -->
    <link rel="stylesheet" href="asset_login/fonts/material-icon/css/material-design-iconic-font.min.css">

    <!-- Main css -->
    <link rel="stylesheet" href="asset_login/css/style1.css">
</head>
            ...
            <div class="signin-content">
                ...
                <div class="signin-form" style="margin-top: 2rem;">
                    <div class="display-flex-center">
                        <img src="asset_user/img/Cianjur.png" alt="" width="20%">
                        <h4>
                            Sistem Informasi Sektor Usaha <br>
                            Diskuperdagin Kab. Cianjur
                        </h4>
                    </div>
