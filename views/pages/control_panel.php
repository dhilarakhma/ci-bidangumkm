                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img border-0 img-fluid" src="<?= $base_url; ?>dist/img/<?= $row_profil->logo_dinas; ?>" alt="User profile picture">
                        </div>

                        <h3 class="profile-username text-center"><?= $row_profil->nama_dinas; ?></h3>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title mt-1">Data Kecamatan</h3>
        ...
        <div class="modal-content">
            ...
            <form action="" method="post">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="submit" name="tambah_kecamatan" class="btn btn-success">Simpan</button>
                </div>
            </form>
        </div>
        <!-- /.modal-content -->
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="nama_dinas">Nama Desa</label>
                        <input type="text" name="nama_dinas" id="nama_dinas" class="form-control" value="<?= $row_profil->nama_dinas; ?>">
                    </div>
                    <div class="form-group">
