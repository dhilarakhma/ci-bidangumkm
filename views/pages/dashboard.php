        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Total Pemilik Usaha</span>
                        <span class="info-box-number">
                            <?php
...
// $rekom_bpnt1 = $mysqli->query("SELECT * FROM tabel_identitas JOIN tabel_konsumsi ON tabel_identitas.NIK = tabel_konsumsi.NIK JOIN tabel_pekerjaan ON tabel_pekerjaan.NIK = tabel_identitas.NIK JOIN tabel_pendidikan ON tabel_pendidikan.NIK = tabel_identitas.NIK JOIN tabel_rumah ON tabel_rumah.NIK = tabel_identitas.NIK JOIN tabel_tabungan ON tabel_tabungan.NIK = tabel_identitas.NIK WHERE tabel_identitas.HBKEL = '1' AND bantuan='0' AND LUAS_LANTAI = '1' AND (JENIS_LANTAI ='Bambu' OR JENIS_LANTAI ='Kayu/Papan') AND (JENIS_DINDING ='Bambu' OR JENIS_DINDING ='Rumbia' OR JENIS_DINDING ='Tembok Tanpa Di Plester') AND FASILITAS_BAB = '0' AND SUMBER_PENERANGAN ='0' AND (SUMBER_AIR_MINUM = 'Sungai' OR SUMBER_AIR_MINUM = 'Mata Air Tidak Terlindung' OR SUMBER_AIR_MINUM = 'Air Hujan') AND (BAHAN_BAKAR_MEMASAK = 'Kayu Bakar' OR BAHAN_BAKAR_MEMASAK = 'Minyak Tanah') AND FREKUENSI_PER_MINGGU <= 1 AND PAKAIAN_PER_TAHUN <= 1 AND MAKAN_PER_HARI <= 2 AND BIAYA_PENGOBATAN = '0' AND PENGHASILAN_PER_BULAN < 600000 AND (PENDIDIKAN_TERAKHIR ='Tidak Tamat SD' OR PENDIDIKAN_TERAKHIR ='Tidak Sekolah' OR PENDIDIKAN_TERAKHIR ='SD dan Sederajat') AND KEPEMILIKAN_TABUNGAN = '0' AND KEC=1");
// $rows_rekom_bpnt1 = mysqli_num_rows($rekom_bpnt1);
// $rekom_bpnt2 = $mysqli->query("SELECT * FROM tabel_identitas JOIN tabel_konsumsi ON tabel_identitas.NIK = tabel_konsumsi.NIK JOIN tabel_pekerjaan ON tabel_pekerjaan.NIK = tabel_identitas.NIK JOIN tabel_pendidikan ON tabel_pendidikan.NIK = tabel_identitas.NIK JOIN tabel_rumah ON tabel_rumah.NIK = tabel_identitas.NIK JOIN tabel_tabungan ON tabel_tabungan.NIK = tabel_identitas.NIK WHERE tabel_identitas.HBKEL = '1' AND bantuan='0' AND LUAS_LANTAI = '1' AND (JENIS_LANTAI ='Bambu' OR JENIS_LANTAI ='Kayu/Papan') AND (JENIS_DINDING ='Bambu' OR JENIS_DINDING ='Rumbia' OR JENIS_DINDING ='Tembok Tanpa Di Plester') AND FASILITAS_BAB = '0' AND SUMBER_PENERANGAN ='0' AND (SUMBER_AIR_MINUM = 'Sungai' OR SUMBER_AIR_MINUM = 'Mata Air Tidak Terlindung' OR SUMBER_AIR_MINUM = 'Air Hujan') AND (BAHAN_BAKAR_MEMASAK = 'Kayu Bakar' OR BAHAN_BAKAR_MEMASAK = 'Minyak Tanah') AND FREKUENSI_PER_MINGGU <= 1 AND PAKAIAN_PER_TAHUN <= 1 AND MAKAN_PER_HARI <= 2 AND BIAYA_PENGOBATAN = '0' AND PENGHASILAN_PER_BULAN < 600000 AND (PENDIDIKAN_TERAKHIR ='Tidak Tamat SD' OR PENDIDIKAN_TERAKHIR ='Tidak Sekolah' OR PENDIDIKAN_TERAKHIR ='SD dan Sederajat') AND KEPEMILIKAN_TABUNGAN = '0' AND KEC=2");
// $rows_rekom_bpnt2 = mysqli_num_rows($rekom_bpnt2);
// $rekom_bpnt3 = $mysqli->query("SELECT * FROM tabel_identitas JOIN tabel_konsumsi ON tabel_identitas.NIK = tabel_konsumsi.NIK JOIN tabel_pekerjaan ON tabel_pekerjaan.NIK = tabel_identitas.NIK JOIN tabel_pendidikan ON tabel_pendidikan.NIK = tabel_identitas.NIK JOIN tabel_rumah ON tabel_rumah.NIK = tabel_identitas.NIK JOIN tabel_tabungan ON tabel_tabungan.NIK = tabel_identitas.NIK WHERE tabel_identitas.HBKEL = '1' AND bantuan='0' AND LUAS_LANTAI = '1' AND (JENIS_LANTAI ='Bambu' OR JENIS_LANTAI ='Kayu/Papan') AND (JENIS_DINDING ='Bambu' OR JENIS_DINDING ='Rumbia' OR JENIS_DINDING ='Tembok Tanpa Di Plester') AND FASILITAS_BAB = '0' AND SUMBER_PENERANGAN ='0' AND (SUMBER_AIR_MINUM = 'Sungai' OR SUMBER_AIR_MINUM = 'Mata Air Tidak Terlindung' OR SUMBER_AIR_MINUM = 'Air Hujan') AND (BAHAN_BAKAR_MEMASAK = 'Kayu Bakar' OR BAHAN_BAKAR_MEMASAK = 'Minyak Tanah') AND FREKUENSI_PER_MINGGU <= 1 AND PAKAIAN_PER_TAHUN <= 1 AND MAKAN_PER_HARI <= 2 AND BIAYA_PENGOBATAN = '0' AND PENGHASILAN_PER_BULAN < 600000 AND (PENDIDIKAN_TERAKHIR ='Tidak Tamat SD' OR PENDIDIKAN_TERAKHIR ='Tidak Sekolah' OR PENDIDIKAN_TERAKHIR ='SD dan Sederajat') AND KEPEMILIKAN_TABUNGAN = '0' AND KEC=3");
// $rows_rekom_bpnt3 = mysqli_num_rows($rekom_bpnt3);

// $penerima_bpnt1 = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BPNT' AND KEC=1");
// $rows_penerima_bpnt1 = mysqli_num_rows($penerima_bpnt1);
// $penerima_bpnt2 = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BPNT' AND KEC=2");
// $rows_penerima_bpnt2 = mysqli_num_rows($penerima_bpnt2);
// $penerima_bpnt3 = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BPNT' AND KEC=3");
// $rows_penerima_bpnt3 = mysqli_num_rows($penerima_bpnt3);

$sql_penerima_bpnt = $mysqli->query("SELECT * FROM tabel_kecamatan");
while($rows_penerima_bpnt = $sql_penerima_bpnt->fetch_assoc()) {
    $output_penerima_bpnt[] = $rows_penerima_bpnt['kecamatan'];

    $penerima_bpnt = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BPNT' AND KEC='$rows_penerima_bpnt[id]'");
...
<?php
// Bantuan PKH
// $rekom_pkh1 = $mysqli->query("SELECT * FROM tabel_identitas JOIN tabel_konsumsi ON tabel_identitas.NIK = tabel_konsumsi.NIK JOIN tabel_pekerjaan ON tabel_pekerjaan.NIK = tabel_identitas.NIK JOIN tabel_pendidikan ON tabel_pendidikan.NIK = tabel_identitas.NIK JOIN tabel_rumah ON tabel_rumah.NIK = tabel_identitas.NIK JOIN tabel_tabungan ON tabel_tabungan.NIK = tabel_identitas.NIK WHERE tabel_identitas.HBKEL = '1' AND bantuan='0' AND LUAS_LANTAI = '1' AND (JENIS_LANTAI ='Bambu' OR JENIS_LANTAI ='Kayu/Papan') AND (JENIS_DINDING ='Bambu' OR JENIS_DINDING ='Rumbia' OR JENIS_DINDING ='Tembok Tanpa Di Plester') AND FASILITAS_BAB = '0' AND SUMBER_PENERANGAN ='0' AND (SUMBER_AIR_MINUM = 'Sungai' OR SUMBER_AIR_MINUM = 'Mata Air Tidak Terlindung' OR SUMBER_AIR_MINUM = 'Air Hujan') AND (BAHAN_BAKAR_MEMASAK = 'Kayu Bakar' OR BAHAN_BAKAR_MEMASAK = 'Minyak Tanah') AND FREKUENSI_PER_MINGGU <= 1 AND PAKAIAN_PER_TAHUN <= 1 AND MAKAN_PER_HARI <= 2 AND BIAYA_PENGOBATAN = '0' AND PENGHASILAN_PER_BULAN < 600000 AND (PENDIDIKAN_TERAKHIR ='Tidak Tamat SD' OR PENDIDIKAN_TERAKHIR ='Tidak Sekolah' OR PENDIDIKAN_TERAKHIR ='SD dan Sederajat') AND KEPEMILIKAN_TABUNGAN = '0' AND KEC=1");
// $rows_rekom_pkh1 = mysqli_num_rows($rekom_pkh1);
// $rekom_pkh2 = $mysqli->query("SELECT * FROM tabel_identitas JOIN tabel_konsumsi ON tabel_identitas.NIK = tabel_konsumsi.NIK JOIN tabel_pekerjaan ON tabel_pekerjaan.NIK = tabel_identitas.NIK JOIN tabel_pendidikan ON tabel_pendidikan.NIK = tabel_identitas.NIK JOIN tabel_rumah ON tabel_rumah.NIK = tabel_identitas.NIK JOIN tabel_tabungan ON tabel_tabungan.NIK = tabel_identitas.NIK WHERE tabel_identitas.HBKEL = '1' AND bantuan='0' AND LUAS_LANTAI = '1' AND (JENIS_LANTAI ='Bambu' OR JENIS_LANTAI ='Kayu/Papan') AND (JENIS_DINDING ='Bambu' OR JENIS_DINDING ='Rumbia' OR JENIS_DINDING ='Tembok Tanpa Di Plester') AND FASILITAS_BAB = '0' AND SUMBER_PENERANGAN ='0' AND (SUMBER_AIR_MINUM = 'Sungai' OR SUMBER_AIR_MINUM = 'Mata Air Tidak Terlindung' OR SUMBER_AIR_MINUM = 'Air Hujan') AND (BAHAN_BAKAR_MEMASAK = 'Kayu Bakar' OR BAHAN_BAKAR_MEMASAK = 'Minyak Tanah') AND FREKUENSI_PER_MINGGU <= 1 AND PAKAIAN_PER_TAHUN <= 1 AND MAKAN_PER_HARI <= 2 AND BIAYA_PENGOBATAN = '0' AND PENGHASILAN_PER_BULAN < 600000 AND (PENDIDIKAN_TERAKHIR ='Tidak Tamat SD' OR PENDIDIKAN_TERAKHIR ='Tidak Sekolah' OR PENDIDIKAN_TERAKHIR ='SD dan Sederajat') AND KEPEMILIKAN_TABUNGAN = '0' AND KEC=2");
// $rows_rekom_pkh2 = mysqli_num_rows($rekom_pkh2);
// $rekom_pkh3 = $mysqli->query("SELECT * FROM tabel_identitas JOIN tabel_konsumsi ON tabel_identitas.NIK = tabel_konsumsi.NIK JOIN tabel_pekerjaan ON tabel_pekerjaan.NIK = tabel_identitas.NIK JOIN tabel_pendidikan ON tabel_pendidikan.NIK = tabel_identitas.NIK JOIN tabel_rumah ON tabel_rumah.NIK = tabel_identitas.NIK JOIN tabel_tabungan ON tabel_tabungan.NIK = tabel_identitas.NIK WHERE tabel_identitas.HBKEL = '1' AND bantuan='0' AND LUAS_LANTAI = '1' AND (JENIS_LANTAI ='Bambu' OR JENIS_LANTAI ='Kayu/Papan') AND (JENIS_DINDING ='Bambu' OR JENIS_DINDING ='Rumbia' OR JENIS_DINDING ='Tembok Tanpa Di Plester') AND FASILITAS_BAB = '0' AND SUMBER_PENERANGAN ='0' AND (SUMBER_AIR_MINUM = 'Sungai' OR SUMBER_AIR_MINUM = 'Mata Air Tidak Terlindung' OR SUMBER_AIR_MINUM = 'Air Hujan') AND (BAHAN_BAKAR_MEMASAK = 'Kayu Bakar' OR BAHAN_BAKAR_MEMASAK = 'Minyak Tanah') AND FREKUENSI_PER_MINGGU <= 1 AND PAKAIAN_PER_TAHUN <= 1 AND MAKAN_PER_HARI <= 2 AND BIAYA_PENGOBATAN = '0' AND PENGHASILAN_PER_BULAN < 600000 AND (PENDIDIKAN_TERAKHIR ='Tidak Tamat SD' OR PENDIDIKAN_TERAKHIR ='Tidak Sekolah' OR PENDIDIKAN_TERAKHIR ='SD dan Sederajat') AND KEPEMILIKAN_TABUNGAN = '0' AND KEC=3");
// $rows_rekom_pkh3 = mysqli_num_rows($rekom_pkh3);

// $penerima_pkh1 = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='PKH' AND KEC=1");
// $rows_penerima_pkh1 = mysqli_num_rows($penerima_pkh1);
// $penerima_pkh2 = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='PKH' AND KEC=2");
// $rows_penerima_pkh2 = mysqli_num_rows($penerima_pkh2);
// $penerima_pkh3 = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='PKH' AND KEC=3");
// $rows_penerima_pkh3 = mysqli_num_rows($penerima_pkh3);

$sql_penerima_pkh = $mysqli->query("SELECT * FROM tabel_kecamatan");
while($rows_penerima_pkh = $sql_penerima_pkh->fetch_assoc()) {
    $output_penerima_pkh[] = $rows_penerima_pkh['kecamatan'];

    $penerima_pkh = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='PKH' AND KEC='$rows_penerima_pkh[id]'");
...
// $rekom_bst2 = $mysqli->query("SELECT * FROM tabel_identitas JOIN tabel_konsumsi ON tabel_identitas.NIK = tabel_konsumsi.NIK JOIN tabel_pekerjaan ON tabel_pekerjaan.NIK = tabel_identitas.NIK JOIN tabel_pendidikan ON tabel_pendidikan.NIK = tabel_identitas.NIK JOIN tabel_rumah ON tabel_rumah.NIK = tabel_identitas.NIK JOIN tabel_tabungan ON tabel_tabungan.NIK = tabel_identitas.NIK WHERE tabel_identitas.HBKEL = '1' AND bantuan='0' AND LUAS_LANTAI = '1' AND (JENIS_LANTAI ='Bambu' OR JENIS_LANTAI ='Kayu/Papan') AND (JENIS_DINDING ='Bambu' OR JENIS_DINDING ='Rumbia' OR JENIS_DINDING ='Tembok Tanpa Di Plester') AND FASILITAS_BAB = '0' AND SUMBER_PENERANGAN ='0' AND (SUMBER_AIR_MINUM = 'Sungai' OR SUMBER_AIR_MINUM = 'Mata Air Tidak Terlindung' OR SUMBER_AIR_MINUM = 'Air Hujan') AND (BAHAN_BAKAR_MEMASAK = 'Kayu Bakar' OR BAHAN_BAKAR_MEMASAK = 'Minyak Tanah') AND FREKUENSI_PER_MINGGU <= 1 AND PAKAIAN_PER_TAHUN <= 1 AND MAKAN_PER_HARI <= 2 AND BIAYA_PENGOBATAN = '0' AND PENGHASILAN_PER_BULAN < 600000 AND (PENDIDIKAN_TERAKHIR ='Tidak Tamat SD' OR PENDIDIKAN_TERAKHIR ='Tidak Sekolah' OR PENDIDIKAN_TERAKHIR ='SD dan Sederajat') AND KEPEMILIKAN_TABUNGAN = '0' AND KEC=2");
// $rows_rekom_bst2 = mysqli_num_rows($rekom_bst2);
// $rekom_bst3 = $mysqli->query("SELECT * FROM tabel_identitas JOIN tabel_konsumsi ON tabel_identitas.NIK = tabel_konsumsi.NIK JOIN tabel_pekerjaan ON tabel_pekerjaan.NIK = tabel_identitas.NIK JOIN tabel_pendidikan ON tabel_pendidikan.NIK = tabel_identitas.NIK JOIN tabel_rumah ON tabel_rumah.NIK = tabel_identitas.NIK JOIN tabel_tabungan ON tabel_tabungan.NIK = tabel_identitas.NIK WHERE tabel_identitas.HBKEL = '1' AND bantuan='0' AND LUAS_LANTAI = '1' AND (JENIS_LANTAI ='Bambu' OR JENIS_LANTAI ='Kayu/Papan') AND (JENIS_DINDING ='Bambu' OR JENIS_DINDING ='Rumbia' OR JENIS_DINDING ='Tembok Tanpa Di Plester') AND FASILITAS_BAB = '0' AND SUMBER_PENERANGAN ='0' AND (SUMBER_AIR_MINUM = 'Sungai' OR SUMBER_AIR_MINUM = 'Mata Air Tidak Terlindung' OR SUMBER_AIR_MINUM = 'Air Hujan') AND (BAHAN_BAKAR_MEMASAK = 'Kayu Bakar' OR BAHAN_BAKAR_MEMASAK = 'Minyak Tanah') AND FREKUENSI_PER_MINGGU <= 1 AND PAKAIAN_PER_TAHUN <= 1 AND MAKAN_PER_HARI <= 2 AND BIAYA_PENGOBATAN = '0' AND PENGHASILAN_PER_BULAN < 600000 AND (PENDIDIKAN_TERAKHIR ='Tidak Tamat SD' OR PENDIDIKAN_TERAKHIR ='Tidak Sekolah' OR PENDIDIKAN_TERAKHIR ='SD dan Sederajat') AND KEPEMILIKAN_TABUNGAN = '0' AND KEC=3");
// $rows_rekom_bst3 = mysqli_num_rows($rekom_bst3);

// $penerima_bst1 = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BST' AND KEC=1");
// $rows_penerima_bst1 = mysqli_num_rows($penerima_bst1);
// $penerima_bst2 = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BST' AND KEC=2");
// $rows_penerima_bst2 = mysqli_num_rows($penerima_bst2);
// $penerima_bst3 = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BST' AND KEC=3");
// $rows_penerima_bst3 = mysqli_num_rows($penerima_bst3);

$sql_penerima_bst = $mysqli->query("SELECT * FROM tabel_kecamatan");
while($rows_penerima_bst = $sql_penerima_bst->fetch_assoc()) {
    $output_penerima_bst[] = $rows_penerima_bst['kecamatan'];

    $penerima_bst = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BST' AND KEC='$rows_penerima_bst[id]'");
...
<?php
// Bantuan BLT
// $rekom_blt1 = $mysqli->query("SELECT * FROM tabel_identitas JOIN tabel_konsumsi ON tabel_identitas.NIK = tabel_konsumsi.NIK JOIN tabel_pekerjaan ON tabel_pekerjaan.NIK = tabel_identitas.NIK JOIN tabel_pendidikan ON tabel_pendidikan.NIK = tabel_identitas.NIK JOIN tabel_rumah ON tabel_rumah.NIK = tabel_identitas.NIK JOIN tabel_tabungan ON tabel_tabungan.NIK = tabel_identitas.NIK WHERE tabel_identitas.HBKEL = '1' AND bantuan='0' AND LUAS_LANTAI = '1' AND (JENIS_LANTAI ='Bambu' OR JENIS_LANTAI ='Kayu/Papan') AND (JENIS_DINDING ='Bambu' OR JENIS_DINDING ='Rumbia' OR JENIS_DINDING ='Tembok Tanpa Di Plester') AND FASILITAS_BAB = '0' AND SUMBER_PENERANGAN ='0' AND (SUMBER_AIR_MINUM = 'Sungai' OR SUMBER_AIR_MINUM = 'Mata Air Tidak Terlindung' OR SUMBER_AIR_MINUM = 'Air Hujan') AND (BAHAN_BAKAR_MEMASAK = 'Kayu Bakar' OR BAHAN_BAKAR_MEMASAK = 'Minyak Tanah') AND FREKUENSI_PER_MINGGU <= 1 AND PAKAIAN_PER_TAHUN <= 1 AND MAKAN_PER_HARI <= 2 AND BIAYA_PENGOBATAN = '0' AND PENGHASILAN_PER_BULAN < 600000 AND (PENDIDIKAN_TERAKHIR ='Tidak Tamat SD' OR PENDIDIKAN_TERAKHIR ='Tidak Sekolah' OR PENDIDIKAN_TERAKHIR ='SD dan Sederajat') AND KEPEMILIKAN_TABUNGAN = '0' AND KEC=1");
// $rows_rekom_blt1 = mysqli_num_rows($rekom_blt1);
// $rekom_blt2 = $mysqli->query("SELECT * FROM tabel_identitas JOIN tabel_konsumsi ON tabel_identitas.NIK = tabel_konsumsi.NIK JOIN tabel_pekerjaan ON tabel_pekerjaan.NIK = tabel_identitas.NIK JOIN tabel_pendidikan ON tabel_pendidikan.NIK = tabel_identitas.NIK JOIN tabel_rumah ON tabel_rumah.NIK = tabel_identitas.NIK JOIN tabel_tabungan ON tabel_tabungan.NIK = tabel_identitas.NIK WHERE tabel_identitas.HBKEL = '1' AND bantuan='0' AND LUAS_LANTAI = '1' AND (JENIS_LANTAI ='Bambu' OR JENIS_LANTAI ='Kayu/Papan') AND (JENIS_DINDING ='Bambu' OR JENIS_DINDING ='Rumbia' OR JENIS_DINDING ='Tembok Tanpa Di Plester') AND FASILITAS_BAB = '0' AND SUMBER_PENERANGAN ='0' AND (SUMBER_AIR_MINUM = 'Sungai' OR SUMBER_AIR_MINUM = 'Mata Air Tidak Terlindung' OR SUMBER_AIR_MINUM = 'Air Hujan') AND (BAHAN_BAKAR_MEMASAK = 'Kayu Bakar' OR BAHAN_BAKAR_MEMASAK = 'Minyak Tanah') AND FREKUENSI_PER_MINGGU <= 1 AND PAKAIAN_PER_TAHUN <= 1 AND MAKAN_PER_HARI <= 2 AND BIAYA_PENGOBATAN = '0' AND PENGHASILAN_PER_BULAN < 600000 AND (PENDIDIKAN_TERAKHIR ='Tidak Tamat SD' OR PENDIDIKAN_TERAKHIR ='Tidak Sekolah' OR PENDIDIKAN_TERAKHIR ='SD dan Sederajat') AND KEPEMILIKAN_TABUNGAN = '0' AND KEC=2");
// $rows_rekom_blt2 = mysqli_num_rows($rekom_blt2);
// $rekom_blt3 = $mysqli->query("SELECT * FROM tabel_identitas JOIN tabel_konsumsi ON tabel_identitas.NIK = tabel_konsumsi.NIK JOIN tabel_pekerjaan ON tabel_pekerjaan.NIK = tabel_identitas.NIK JOIN tabel_pendidikan ON tabel_pendidikan.NIK = tabel_identitas.NIK JOIN tabel_rumah ON tabel_rumah.NIK = tabel_identitas.NIK JOIN tabel_tabungan ON tabel_tabungan.NIK = tabel_identitas.NIK WHERE tabel_identitas.HBKEL = '1' AND bantuan='0' AND LUAS_LANTAI = '1' AND (JENIS_LANTAI ='Bambu' OR JENIS_LANTAI ='Kayu/Papan') AND (JENIS_DINDING ='Bambu' OR JENIS_DINDING ='Rumbia' OR JENIS_DINDING ='Tembok Tanpa Di Plester') AND FASILITAS_BAB = '0' AND SUMBER_PENERANGAN ='0' AND (SUMBER_AIR_MINUM = 'Sungai' OR SUMBER_AIR_MINUM = 'Mata Air Tidak Terlindung' OR SUMBER_AIR_MINUM = 'Air Hujan') AND (BAHAN_BAKAR_MEMASAK = 'Kayu Bakar' OR BAHAN_BAKAR_MEMASAK = 'Minyak Tanah') AND FREKUENSI_PER_MINGGU <= 1 AND PAKAIAN_PER_TAHUN <= 1 AND MAKAN_PER_HARI <= 2 AND BIAYA_PENGOBATAN = '0' AND PENGHASILAN_PER_BULAN < 600000 AND (PENDIDIKAN_TERAKHIR ='Tidak Tamat SD' OR PENDIDIKAN_TERAKHIR ='Tidak Sekolah' OR PENDIDIKAN_TERAKHIR ='SD dan Sederajat') AND KEPEMILIKAN_TABUNGAN = '0' AND KEC=3");
// $rows_rekom_blt3 = mysqli_num_rows($rekom_blt3);

// $penerima_blt1 = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BLT' AND KEC=1");
// $rows_penerima_blt1 = mysqli_num_rows($penerima_blt1);
// $penerima_blt2 = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BLT' AND KEC=2");
// $rows_penerima_blt2 = mysqli_num_rows($penerima_blt2);
// $penerima_blt3 = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BLT' AND KEC=3");
// $rows_penerima_blt3 = mysqli_num_rows($penerima_blt3);

$sql_penerima_blt = $mysqli->query("SELECT * FROM tabel_kecamatan");
while($rows_penerima_blt = $sql_penerima_blt->fetch_assoc()) {
    $output_penerima_blt[] = $rows_penerima_blt['kecamatan'];

    $penerima_blt = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BLT' AND KEC='$rows_penerima_blt[id]'");
...
$penerima_bpnt = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BPNT'");
$rows_penerima_bpnt = mysqli_num_rows($penerima_bpnt);
$penerima_pkh = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='PKH'");
$rows_penerima_pkh = mysqli_num_rows($penerima_pkh);
$penerima_bst = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BST'");
$rows_penerima_bst = mysqli_num_rows($penerima_bst);
$penerima_blt = $mysqli->query("SELECT * FROM tabel_identitas WHERE bantuan=1 AND jenis_bantuan='BLT'");
