 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #042165;">
   ...
   <img src="<?= $base_url; ?>asset_user/img/Cianjur.png" alt="Logo" class="brand-image">
     <img src="<?= $base_url; ?>asset_user/img/logo2022.png" alt="Logo" class="brand-image">
   ...
   <div class="sidebar">
     ...
     <nav class="mt-2">
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item has-treeview">
           <a href="<?= $base_url; ?>data_identitas" class="nav-link">
