...
$base_url = 'http://localhost/ci-bidangumkm/';
...
<div class="content-wrapper">
    ...
    } else if (isset($_GET['views']) && $_GET['views'] == "data_identitas") {
        include 'views/pages/data_identitas.php';
    } else if (isset($_GET['views']) && $_GET['views'] == "input_data_identitas") {
        include 'views/pages/input_data_identitas.php';
    } else if (isset($_GET['views']) && $_GET['views'] == "edit_data_identitas") {
        include 'views/pages/edit_data_identitas.php';
    ...
    } else if (isset($_GET['views']) && $_GET['views'] == "detail_identitas") {
        include 'views/pages/detail_identitas.php';
